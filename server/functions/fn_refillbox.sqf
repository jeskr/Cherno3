...
switch (_boxType) do
{
	case "mission_USLaunchers":
	{
		...
		[
			...
			["wep", ["CUP_launch_Igla", "CUP_launch_FIM92Stinger", "CUP_launch_9K32Strela"], RANDOM_BETWEEN(3,5), RANDOM_BETWEEN(1,2)],
			["wep", ["launch_Titan_F"], RANDOM_BETWEEN(1,2), RANDOM_BETWEEN(1,2)],
			["wep", ["CUP_launch_Javelin", "CUP_launch_Metis"], RANDOM_BETWEEN(3,5), RANDOM_BETWEEN(1,2)],
            ["wep", ["CUP_launch_M47", "CUP_launch_M136", "CUP_launch_MAAWS_Scope", "CUP_launch_NLAW"], RANDOM_BETWEEN(3,5), RANDOM_BETWEEN(1,2)],
			["wep", ["CUP_launch_RPG7V", "CUP_launch_RPG18", "CUP_launch_Mk153Mod0_SMAWOptics", "CUP_launch_Mk153Mod0"], RANDOM_BETWEEN(3,5), RANDOM_BETWEEN(1,2)],
	...
	case "mission_USSpecial":
	{
		...
		[
			...
			//["wep", ["CUP_lmg_L110A1", "CUP_lmg_M249_para"], RANDOM_BETWEEN(1,3), RANDOM_BETWEEN(2,4)],
	...
	case "mission_TOP_Sniper":
	{
		...
		[
			...
			["wep", ["CUP_srifle_AS50", "CUP_srifle_M107_LeupoldVX3"], RANDOM_BETWEEN(1,5), RANDOM_BETWEEN(4,6)],
			["wep", ["srifle_EBR_F", "srifle_DMR_01_F"], RANDOM_BETWEEN(1,3), RANDOM_BETWEEN(4,6)],			
			["wep", "Rangefinder", RANDOM_BETWEEN(1,3)],
			["itm", ["optic_DMS","optic_DMS","optic_Nightstalker","optic_tws"], RANDOM_BETWEEN(1,3)]
		];
	};
	case "mission_TOP_Gear1":
	{
		...
		[
			...
			["bac", "CUP_US_Backpack_EP1", RANDOM_BETWEEN(1,5)],
			["bac", "CUP_B_AlicePack_Khaki_Ammo", RANDOM_BETWEEN(1,5)],
