...
_setupObjects =
{
	...
	switch (true) do
	{
		...
		//CUP
		case (_vehicle isKindOf "CUP_BAF_Jackal2_GMG_D"):
		{
			_vehicle setVehicleAmmoDef 1;
		...
		//CUP
		case (_vehicle isKindOf "CUP_B_Dingo_Des"):
		{
			_vehicle setVehicleAmmoDef 1;
		...
		//CUP
		case (_vehicle isKindOf "CUP_B_Dingo_GL_Des"):
		{
			_vehicle setVehicleAmmoDef 1;
		...
		//CUP
		case (_vehicle isKindOf "CUP_B_M1135_ATGMV_Desert"):
		{
			_vehicle setVehicleAmmoDef 1;
		...
		//CUP
		case (_vehicle isKindOf "CUP_O_BTR90_HQ_RU"):
		{
			_vehicle setVehicleAmmoDef 1;
		...
		//CUP
		case (_vehicle isKindOf "CUP_B_HMMWV_Avenger_USA"):
		{
			_vehicle setVehicleAmmoDef 1;
		...
		//CUP
		case (_vehicle isKindOf "CUP_O_KA50_RU"):
		{
			_vehicle setVehicleAmmoDef 1;
		...
		case (_vehicle isKindOf "CUP_B_Mi35_CZ"):
		{
			_vehicle setVehicleAmmoDef 1;
		...
		case (_vehicle isKindOf "CUP_B_UH60L_US"):
		{
			_vehicle setVehicleAmmoDef 1;
		...
		case (_vehicle isKindOf "CUP_B_Mi24_D_CDF"):
		{
			_vehicle setVehicleAmmoDef 1;
		...
		case (_vehicle isKindOf "CUP_B_AH1Z"):
		{
			_vehicle setVehicleAmmoDef 1;
